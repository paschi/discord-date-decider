...
type Client interface {
	...
	ExpirePoll(channelID string, messageID string) error
}
...
func (c *DefaultClient) ExpirePoll(channelID string, messageID string) error {
	_, err := c.session.PollExpire(channelID, messageID)
	return err
}
